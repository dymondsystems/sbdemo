// Select the container where the content will be rendered
...
<div class="page-wrapper chiller-theme toggled">
  ...
  <nav id="sidebar" class="sidebar-wrapper">
    <div class="sidebar-content">
      ...
      <div class="sidebar-header">
        <div class="user-pic">
          <img class="img-responsive img-rounded" src="https://pbs.twimg.com/profile_images/1237550450/mstom_400x400.jpg" alt="User picture">
        </div>
        <div class="user-info">
  ...
  <nav class="navbar navbar-expand-sm bg-dark navbar-dark">
    <a class="navbar-brand" href="#">
      <h3><i class="fa fa-th"></i> stack board</h3>
    </a>
          ...
          <div class="dropdown">
            <div class="dropdown-menu" style="right:0; left: auto; font-size:12px;">
              ...
              <a class="dropdown-item" data-toggle="modal" href="#accountinfo">
                ...
                <br>
                Thank you for trying stack board! <br>Take and tour and find out...
              </a>
              <hr>
              <a class="dropdown-item" data-toggle="modal" href="#accountinfo">
                <img class="lib-img-show" src="https://upload.wikimedia.org/wikipedia/commons/thumb/c/c1/Google_%22G%22_logo.svg/1200px-Google_%22G%22_logo.svg.png" alt="HTML tutorial" style="width:25px;height:25px; margin-right: 10px;"> <strong>Welcome to stack board!</strong>
        ...
        <main role="main">
          <div class="container">
            <div id="noSectionsPlaceholder" class="text-center" style="display: none; margin-top: 100px; margin-bottom: 100px;">
              ...
              <br><br><button type="button" class="btn btn-success" data-toggle="modal" data-target="#addsection">Create a stack</button>
            </div>
            ...
            <div id="searchResultsContainer" class="row d-none"></div>
            <div class="container mt-4">
              <div class="row align-items-center">
                ...
                <div class="col-auto">
                  <button type="button" class="btn btn-success" data-toggle="modal" data-target="#addsection">New stack</button>
                </div>
              </div>
            </div>
            ...
            <div id="popUpSidebar" class="sidebar">
              ...
              <div class="side" style="position: fixed; right:30px; bottom: 40px;">
...
// Render the HTML content into the container
